...
public class BankClient extends Agent implements BankVocabulary {
// -------------------------------------------------------------------

   /**
	 * 
	 */
private static final long serialVersionUID = 5369146406881591976L;
...
// ------------------------------------------------  Get the user command
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2440179629475783676L;
...
/**
	 * 
	 */
	private static final long serialVersionUID = 8419117185952275596L;
...
//                                                       no response from the server
      WaitServerResponse(Agent a) {
         ...
         addSubBehaviour(new WakerBehaviour(myAgent, 5000) {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 2597617726597943286L;
...
// -----------------------------------------------  // Receive and handle server responses
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2271580229139314231L;
...
// ---------------------
      ...
      System.out.print("\n\t<<---- SPARKASSE ACCOUNT - MENU ---->>" +
    		  		   "\nGibt es hier eine Bank, die mir mein Bargeld nach Hause bringt" +
                       "\n\n\t0. Terminate program" +
